...
<h3 align="center">
  Desafio 3-4: Refatorando Foodfy
</h3>
...
Até esse módulo não conhecíamos sobre back-end, todos dados da nossa página ficavam no próprio front-end (arquivos HTML).

Agora que conhecemos sobre Node.js vamos tornar a exibição dos dados mais dinâmica :rocket:

### Arquivo de dados

Crie um arquivo `data.js` na raiz do seu projeto com o conteúdo das receitas.
